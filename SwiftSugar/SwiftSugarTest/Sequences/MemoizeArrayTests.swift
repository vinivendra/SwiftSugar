//import XCTest
//
//class MemoizeArrayTests: XCTestCase {
//
//    let testsCount = 15
//
...
//    }
//
//    func testMemoizedSequenceResults() {
//        let sequences = [
//            MemoizedSequence(first: 1, incrementer: incrementer,
//                closure: fibonacciClosure),
//            MemoizedSequence(first: 1, incrementer: incrementer,
//                closure: factorialClosure),
//            MemoizedSequence(first: 1, closure: fibonacciClosure),
//            MemoizedSequence(first: 1, closure: factorialClosure),
//            MemoizedSequence(fibonacciClosure),
//            MemoizedSequence(factorialClosure),
//            MemoizedSequence(first: 1, incrementer: incrementer,
//                function: fibonacciFunction),
//            MemoizedSequence(first: 1, incrementer: incrementer,
//                function: factorialFunction),
//            MemoizedSequence(first: 1, function: fibonacciFunction),
//            MemoizedSequence(first: 1, function: factorialFunction),
//            MemoizedSequence(fibonacciFunction),
//            MemoizedSequence(factorialFunction)]
//
...
//
//                testMemoizedSequenceResults(sequence, sequenceName: name,
//                    testNumbers: results)
//                testContains(sequence, sequenceName: name, number: example)
//        }
//    }
//
//    func testMemoizedSequenceResults(sequence: MemoizedSequence<Int, Int>,
...
//    }
//
//    func testContains(sequence: MemoizedSequence<Int, Int>,
